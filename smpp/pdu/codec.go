...
import (
	...
	"github.com/nazirok/go-smpp/smpp/pdu/pdufield"
	"github.com/nazirok/go-smpp/smpp/pdu/pdutlv"
)
...
func Decode(r io.Reader) (Body, error) {
	...
	case AlertNotificationID:
		// TODO(nazirok): Implement AlertNotification.
	...
	case CancelSMID:
		// TODO(nazirok): Implement CancelSM.
	case CancelSMRespID:
		// TODO(nazirok): Implement CancelSMResp.
	case DataSMID:
		// TODO(nazirok): Implement DataSM.
	case DataSMRespID:
		// TODO(nazirok): Implement DataSMResp.
	case DeliverSMID:
	...
	case OutbindID:
		// TODO(nazirok): Implement Outbind.
	case QuerySMID:
		return decodeFields(newQuerySM(hdr), b)
	case QuerySMRespID:
		return decodeFields(newQuerySMResp(hdr), b)
	case ReplaceSMID:
		// TODO(nazirok): Implement ReplaceSM.
	case ReplaceSMRespID:
		// TODO(nazirok): Implement ReplaceSMResp.
	case SubmitMultiID:
